...
const MainPageInfo = () => {
  return (
    <div className="flex flex-col gap-5 items-start md:text-center pt-10!">
      <p className="uppercase!">канцелярский магазин бишкек</p>
      <h1 className="text-[50px] md:text-[96px] font-semibold letter-spacing-[2%] text-start text-[#1E2D42]">
      ...
      <div className="flex gap-5 md:gap-50 my-20">
