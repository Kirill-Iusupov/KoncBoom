...
const PAGE_SIZE = 4; // Количество товаров на одну страницу
      ...
      <Wrapper>
        <div className="flex justify-end mb-[20px] mt-[20px]">
          <button
            ...
            disabled={items.length === 0} // Отключаем, если пусто
          ...
          <div className="relative min-h-[600px] flex flex-col md:flex-row gap-[50px] justify-between">
            ...
            <div className="flex w-full mb-[45px] flex-col gap-[15px] md:gap-[40px]">
              {currentItems.map((product) => (
                <div key={product.id}>
                  {/* Передаем реальный товар из стора */}
                  <CartCard product={product} /> 
                </div>
              ))}
              
              {/* Показываем пагинацию только если товаров больше, чем PAGE_SIZE */}
